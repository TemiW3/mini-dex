...
export type CloseInput<
  ...
  TAccountMinidex extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountMinidex>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountMinidex> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.minidex),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountMinidex>;
